...
-->
# 详细教程和文件位置
非常新的内核版本了，有近两年顶会用的4.几，但5.0好像很有标志性。往里加注释，调试文件系统都用这个版本了（目前又用z-journal那个4.几了）。

调试文件系统详细版教程（现在这个更新了下，比较新，主要是也更详细）：
...
qemu-system-x86_64 \
    ...
    -drive file=/home/zy/lab/disk.qcow,if=none,id=nvme1 \
```
